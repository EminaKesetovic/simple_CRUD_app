<template>
    <div class="row">
        <div class="col-12 mb-2 text-end">
            <button class="btn btn-primary" v-on:click="getIndustryTypes()">Refresh</button>
            <router-link :to='{name:"industryTypeAdd"}' class="btn btn-success">Create</router-link>
        </div>
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group">
                            <input type="search" class="form-control" v-model="filter" placeholder="Search industry types...">
                        </div>
                    </div>
                    <br>
